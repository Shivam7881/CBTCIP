...
<%@page import="com.cbtcip2.digital_library_management.dto.Writers"%>
<%@page import="java.io.Writer"%>
<%@page import="com.cbtcip2.digital_library_management.admin.dao.BookDao"%>
<%@page import="com.cbtcip2.digital_library_management.dto.Books"%>
...
<body>
	...
	<table class="table align-middle mb-0 bg-white">
		...
		for (Books book : books) {
			...
			String email =(String)httpSession.getAttribute("writerSession");
			
			if(email.equalsIgnoreCase(writer.getEmail())){
		%>
		...
		<tbody>
			<tr>
				...
				<td><a href="book-edit-writer.jsp?id=<%=book.getId()%>"><span
						class="badge badge-success rounded-pill d-inline">EDIT</span></a></td>
				<td><a href="deleteBook?id=<%=book.getId()%>"><span
